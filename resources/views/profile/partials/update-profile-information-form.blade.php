<section class="space-y-6">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="email" name="email" type="email" class="mt-1 block w-full focus:ring-emerald-500 focus:border-emerald-500" :value="old('email', $user->email)" required autocomplete="username" />
